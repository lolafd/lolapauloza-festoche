    ...
    <div className="flex flex-col items-start gap-2 max-w-[140px] text-left">
      ...
      <p className="text-[12px] text-[#4A8898] leading-relaxed">
        ...
        <div className="bg-[#F6CC451F] border-l-[3px] border-[#F6CC45] p-6 rounded-r">
          <p className="text-[13px] leading-[1.7] opacity-80">
            <strong className="text-[#F6CC45] font-medium">L'essentiel :</strong> Personne dans les maisons, tout le monde dehors. Lolapauloza est un festival privé qui va se dérouler chez papi Michel et chez maman Charlotte Desoblin, donc cette règle est à respecter pour que Paulo ne soit pas déshérité.
          </p>
        </div>
      </div>
    </div>
